...
public class PrimitiveTypeFactory implements ITypeFactory {
	...
	/**
	 * Creates an instance of a primitive class. Compares the argument class
	 * against the class in java.lang and the primitive type before creating the
	 * instance.
	 * 
	 * @param primitiveType
	 *            A Class object representing a primitive type
	...
	public Object create(Class<?> primitiveType) {
		...
		} else if (primitiveType.equals(Character.class)
