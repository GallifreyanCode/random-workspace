...
public class AlbumRepository implements GenericRepository<Album, Long>
{
	...
	{
		TypedQuery<Album> findAllAlbumsQuery = em.createNamedQuery("Album.findAllAlbums",
				Album.class);
	...
	{
		TypedQuery<Album> findAllAlbumsQuery = em.createNamedQuery("Album.findAllAlbumsByOwner",
				Album.class);
	...
	{
		TypedQuery<Album> findAlbumQuery = em.createNamedQuery("Album.findAlbumByOwnerAndId",
				Album.class);
